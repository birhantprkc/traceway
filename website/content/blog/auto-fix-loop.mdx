...
author: "dusan"
image: "/blog/auto-fix-loop/og.png"
...
The first time the result was a PR, which you can find [here](https://github.com/tracewayapp/traceway/pull/279). I really liked the approach: it stopped escalating an error that can be triggered by bots or by users simply waiting too long to authenticate. What I really disliked was the code that was written, pointless comments and a function that could literally just be a direct if statement. It's the solution I would go for but not the code I would have written.
