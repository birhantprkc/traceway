...
};`}};let a=ue("vite"),d=ue(!1),f=ue(!1),l=ue(!1),v=ue(!1),b=ue(!1),y=ue(!1),T=ue(!1),A=ue(!1),m=ue(!1),w=ue(!1),S=ue(!1);const p="npm install -D @tracewayapp/bundler-plugin",u=z(()=>it.currentProject),E=z(()=>r(u)?.sourceMapToken??null),$=z(()=>Kt.getRoleForOrganization(r(u)?.organizationId??0)==="readonly"),h=z(()=>r(u)?.framework==="flutter"),x=z(()=>r(u)?.framework==="ios"),N=z(()=>r(u)?.framework==="android"),C=z(()=>r(h)||r(x)||r(N)?"debug symbols":"source maps"),P=z(()=>r(u)?.framework!=="react-native"),B=z(()=>r(u)&&r(E)?`npx @tracewayapp/sourcemap-upload \\
  --url ${r(u).backendUrl} \\
  --token ${r(E)} \\
