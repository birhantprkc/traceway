...
<img src="/symbolication-flows.png" alt="Symbolication flows: upload, matching, caching" style={{ maxWidth: '100%', height: 'auto' }} />
...
- **[Android](/symbolicator/android)** — obfuscated R8 release crashes and `mapping.txt` retrace.
